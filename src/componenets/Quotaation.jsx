...
import { Container, Paper, Typography, TextField, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Button, Box } from '@mui/material';
    ...
    const handleDownloadPDF =async  () => {
        ...
        doc.addImage(watermarkImage, 'PNG', 0, 100, 600, 500, '', 'FAST');
          autoTable(doc, {
            ...
            head: [['S.NO', 'Item Name', 'Material Description', 'Price', 'Approx Order', 'Total Amount']],
    ...
    return (
        <Container>
            <Paper elevation={3} sx={{ padding: 3, marginTop: 3 }}>
                ...
                <Box>
                    <Button onClick={listen} sx={{textTransform:"none"}} color='success'> <MicIcon /> Start Listening</Button>
                    <Button onClick={stop} sx={{textTransform:"none"}} color='error'><StopIcon /> Stop</Button>
                ...
                /><Button onClick={()=>speak({text:'Addres enter cheyyandi'})} sx={{textTransform:"none"}} color='secondarygit '><VolumeUpIcon /> Speak</Button>
